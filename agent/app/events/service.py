...
EVENT_TYPES = {
    ...
    "POSSIBLE_CONCEALMENT", "POSSIBLE_SMOKE", "POSSIBLE_FIRE", "TRACK_LOST", "POSSIBLE_PRODUCT_REPLACEMENT",
    "CAMERA_TAMPERED",
}
# The ones a person should look at; the rest are context for correlation/debug.
SECURITY_TYPES = {"POSSIBLE_UNPAID_EXIT", "POSSIBLE_PRODUCT_REPLACEMENT", "RESTRICTED_ZONE_ENTRY", "AFTER_HOURS_PERSON",
